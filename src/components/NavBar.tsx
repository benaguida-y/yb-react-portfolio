...
const NavBar = () => {
  ...
  return (
    <nav className="fixed border top-0 left-0 right-0 z-50 px-6 bg-[#0f1720]/40 backdrop-blur-md mt-2 mx-2 rounded-2xl">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between h-14 items-center">

          {/* Logo (Left) */}
          <div className="flex-shrink-0 flex items-center w-[88px]">
            {/* <NavLink to="/">
              <img
                src={logo}
                alt="YB Logo"
          ...
          <div className="hidden md:flex flex-1 justify-center items-center space-x-4">
            ...
            <NavLink to="/about-detailed" className={({ isActive }) => getNavLinkClass(isActive)}>
              About
            </NavLink>
            <NavLink to="/skills-detailed" className={({ isActive }) => getNavLinkClass(isActive)}>
              Skills
            </NavLink>
            <NavLink to="/projects-detailed" className={({ isActive }) => getNavLinkClass(isActive)}>
              Projects
            </NavLink>
          </div>
