                                ...
                                <AccordionContent>
                                    {cvLanguages.map((lan, index) => (
                                        <div key={index} className=" border-l-2 border-[#163853] flex flex-col">
                                            <p className="text-white flex items-center gap-1">• {lan.name.en} – {lan.level.en}</p>
                                        </div>
                                    ))}
                                </AccordionContent>
                            </AccordionItem>
                            ...
                            <AccordionItem value="item-3">
                                ...
                                <AccordionContent>
                                    {cvSkills.map((skill, index) => (
                                        <div key={index} className=" border-l-2 border-[#163853] flex flex-col">
                                            <p className="text-white flex items-center gap-1">• {skill.name.en}</p>
                                        </div>
                                    ))}
                                </AccordionContent>
                            </AccordionItem>
                            ...
                            <AccordionItem value="item-4">
                                ...
                                <AccordionContent>
                                    {cvInterests.map((inter, index) => (
                                        <div key={index} className=" border-l-2 border-[#163853] flex flex-col">
                                            <p className="text-white flex items-center gap-1">• {inter.name.en}</p>
                                        </div>
                                    ))}
                                </AccordionContent>
                            </AccordionItem>
                ...
                <div className="basis-2/3 px-6 py-12">
                    ...
                    {cvSummaries.map((inf, index) => (
                        <div key={index} className="mb-10">
                            ...
                            <p className="text-2xl text-muted-foreground w-max pb-2">{inf.title.en}</p>
                            <p className="text-xs text-muted-foreground italic pl-4 pb-2">{inf.description.en}</p>
                                    ...
                                    {cvFormations.map((edu, index) => (
                                        <div key={index} className="pb-6 border-l-2 border-[#163853]">
                                            <h1 className="text-l font-bold">
                                                <span className="text-[#163853]">•</span> {edu.title.en}
                                            </h1>
                                            <p className="pl-4">{edu.institution.en}</p>
                                            <p className="pl-4 text-muted-foreground italic font-light text-xs">{edu.period.en}</p>
                                            {edu.description && (
                            ...
                            <AccordionItem value="item-3">
                                ...
                                <AccordionContent>
                                    {cvTechnicalSkills.map((category, index) => (
                                        <div key={index} className="pb-6 border-l-2 border-[#163853]">
                                            <h1 className="text-l font-bold">
                                                <span className="text-[#163853]">•</span> {category.title.en}
                                            </h1>

                                            {category.sections.map((section, i) => (
                                                <div key={i}>
                                                    {section.title && (
                                                        <p className="pl-4">{section.title.en}</p>
                                                    )}
